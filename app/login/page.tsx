...
function LoginContent() {
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', justifyContent: 'center', alignItems: 'center', backgroundColor: 'var(--bg)' }}>
      <div className="card" style={{ width: '100%', maxWidth: '400px' }}>
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          <h1 style={{ fontSize: '1.5rem', fontWeight: 800 }}>Welcome to Job YARD</h1>
          <p style={{ color: 'var(--text2)', fontSize: '0.875rem' }}>Sign in to continue</p>
        </div>
